...
AS SELECT * FROM cloud_files('${source}/events', "csv", map("cloudFiles.inferColumnTypes", "true"))
...
AS SELECT * FROM cloud_files('${source}/users', "json", map("cloudFiles.inferColumnTypes", "true"))
